...
/***/ function(module, exports, __webpack_require__) {
	...
	var topicEvents = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var passwordChange = function passwordChange(success, failure, data) {
	  //if(!app.user) bad;
	  $.ajax({
	    method: "PATCH",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var authApi = __webpack_require__(5);
	var display = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayMain = function displayMain() {
	  var mainTemplate = __webpack_require__(9);
	  $('#AskEstherContainer').html(mainTemplate());
	};

	var displayTopic = function displayTopic(topics) {
	  var topicTemplate = __webpack_require__(29);
	  $('#AskEstherContainer').html(topicTemplate({
	    topics: topics
	  }));
	};

	var displayNYTArticle = function displayNYTArticle(articles) {
	  var nytTemplate = __webpack_require__(30);
	  var test = articles.multimedia;
	...
	var displayRatings = function displayRatings(ratings, topicID) {
	...
	module.exports = {
	  ...
	  displayNYTArticle: displayNYTArticle
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"landing-page\">\n  <div class=\"header-content\">\n    <div class=\"inner\">\n      <h1 class=\"landing-text\">Need a topic? Ask Esther!</h1>\n\n      <div class=\"image\">\n        <div class=\"avatar-center\">\n          <img src=\"./assets/images/esther.png\" class=\"guide\">\n        </div>\n        <div>\n          <p class=\"speech\"></p>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class=\"speechBubble\">\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"landing-page\">\n  <div class=\"header-content\">\n    <div class=\"inner\">\n      <h1 class=\"landing-text\">Need a topic? Ask Esther!</h1>\n\n      <div class=\"image\">\n        <div class=\"avatar-center\">\n          <img src=\"./assets/images/esther.png\" class=\"guide\">\n          <div class=\"speech\">\n            <p class=\"topic esther\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.topics : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.topics : depth0)) != null ? stack1.content : stack1), depth0))
	    + "</p>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"nyt-template\">\n  <div class=\"panel panel-primary\">\n  <div class=\"panel-heading\">\n    <h2 class=\"panel-title title\">Title: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.articles : depth0)) != null ? stack1.title : stack1), depth0))
	    + "</h2>\n  </div>\n  <div class=\"panel-body\">\n    <ul class=\"list-group\">\n    <li class=\"list-group-item\"><span class=\"bold\">Abstract:</span> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.articles : depth0)) != null ? stack1["abstract"] : stack1), depth0))
	    + "</li>\n    <li class=\"list-group-item\"><span class=\"bold\">Section:</span> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.articles : depth0)) != null ? stack1.section : stack1), depth0))
	    + "</li>\n    <li class=\"list-group-item\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.articles : depth0)) != null ? stack1.byline : stack1), depth0))
	    + "</li>\n  </ul>\n  </div>\n  <div class=\"container-fluid\">\n  <div class=\"row\">\n      <div class=\"image\">\n        "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.articles : depth0)) != null ? stack1.multimedia : stack1)) != null ? stack1.format : stack1), depth0))
	    + "\n        <p>Link: <a href=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.articles : depth0)) != null ? stack1.short_url : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.articles : depth0)) != null ? stack1.title : stack1), depth0))
	    + "</a></p>\n      </div>\n</div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var topicApi = __webpack_require__(32);
	var topicUi = __webpack_require__(33);

	var topicHandlers = function topicHandlers() {
	  //-----------Topic Events-----------//
	  ...
	  $('#submit-rating').on('click', function (event) {
	    var score = $('input[name="myrating"]:checked').val();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getRandomTopic = function getRandomTopic(success, failure) {
	  $.ajax({
	    method: "GET",
	...
	var getNytArticle = function getNytArticle(success, failure) {
	  $.ajax({
	    method: "GET",
	...
	var getRatings = function getRatings(topicID) {
	  $.ajax({
	    // method: 'GET',
	...
	var createRating = function createRating(success, failure, score, topic_id) {
	  $.ajax({
	    method: 'POST',
	    url: app.server.api + '/ratings/',
	    headers: {
	  ...
	  }).done(success, topic_id).fail(failure);
	};

	var updateRating = function updateRating(success, failure, score, id) {
	  $.ajax({
	    method: 'PATCH',
	...
	var deleteRating = function deleteRating(success, failure, id) {
	  $.ajax({
	    method: 'DELETE',
	    url: app.server.api + '/ratings/' + id,
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var authTopics = __webpack_require__(32);
	var display = __webpack_require__(8);
	...
	var getTopicSuccess = function getTopicSuccess(data) {

	  display.displayTopic(data.topic);
	  authTopics.getRatings(data.topic.id);
	};

	var getNytArticleSuccess = function getNytArticleSuccess(data) {

	  display.displayNYTArticle(data);
	};

	var ratingSuccess = function ratingSuccess(data) {
	  $('#rating-success').removeClass('hidden').fadeOut(2000, function () {
	    $('#rating-success').addClass('hidden').show();
	  });
	  $('#submit-rating, #update-rating').addClass('hidden');
	  var topic_id = data.rating.topic.id;
	  authTopics.getRatings(topic_id);
	};

	var updateRatingSuccess = function updateRatingSuccess(data) {
	  $('#rating-success').removeClass('hidden').fadeOut(2000, function () {
	    $('#rating-success').addClass('hidden').show();
	  });
	};

	var deleteRatingSuccess = function deleteRatingSuccess(data) {
	  $('#rating-success').removeClass('hidden').fadeOut(2000, function () {
	    $('#rating-success').addClass('hidden').show();
	  });
	...
	module.exports = {
	  failure: failure,
	  success: success,
	  getTopicSuccess: getTopicSuccess,
	  getNytArticleSuccess: getNytArticleSuccess,
	  updateRatingSuccess: updateRatingSuccess,
	  deleteRatingSuccess: deleteRatingSuccess,
